...
function shengcheng(neirong)
{
	...
	else
	{
		...
		img.onload = function()
		{
			...
			document.getElementById('notice').innerHTML="<p>二维码生成成功！&nbsp;<a class='btn' href='"+image+"' target='_blank' title='立即下载'>立即下载</a>&nbsp</p><p>"+share("我的二维码，用QREncoder制作的！QREncoder可以将文本、网址、电话、短信、邮件甚至名片等信息快速转换为二维条形码。","我的二维码，用QREncoder制作的！QREncoder可以将文本、网址、电话、短信、邮件甚至名片等信息快速转换为二维条形码。","http://qrencoder.sinaapp.com",encodeURIComponent(image))+"</p>";
